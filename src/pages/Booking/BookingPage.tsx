...
import type { PNR, PNRDetail, PNRSummary } from '../../types/api';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="premium-card p-6 flex items-start gap-4 bg-amber-50/50 border border-amber-100">
        ...
        <p className="text-sm text-amber-800">
          You'll need a flight_id/fare_class_id in hand (check the Flights page's Manage
          Instances tab, or the flight search results).
        </p>
      </div>
